    ...
    <div className=' w-full min-h-screen p-6 flex flex-col gap-6'>
      ...
      <div className="images flex flex-col gap-16  ">
        ...
        <div className="img bordcer rounded-2xl shadow-2xl">
          <Image src="/route2.png" height={1000} width={1000} alt="" />
        </div>
        <div className="img bordcer rounded-2xl shadow-2xl">
          <Image src="/r21.png" height={1000} width={1000} alt="" />
        </div>
        <div className="img bordcer rounded-2xl shadow-2xl">
          <Image src="/r23.jpg" height={1000} width={1000} alt="" />
        </div>
        <div className="img bordcer rounded-2xl shadow-2xl">
          <Image src="/r24.png" height={1000} width={1000} alt="" />
        </div>
      </div>
