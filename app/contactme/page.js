...
const page = () => {
    ...
    return (
        <div className='main w-full min-h-screen  flex flex-col lg:flex-row gap-4     '>
            <div className="b1 bg-gray-00 lg:w-1/2 w-full  p-8 flex flex-col rounded-2xl">
                ...
                <div className='bg-gray-100 shadow-2xl rounded-xl h-full  w-full  flex  flex-col justify-center gap-4 p-4'>
                    ...
                    <div className='flex items-center gap-6'>
                        ...
                        <Link href="https://www.linkedin.com/in/llookkeesshh00"><span className=' font-medium underline '>https://www.linkedin.com/in/llookkeesshh00</span></Link>
                    </div>
                    <div className='flex items-center gap-6'>
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
                        ...
                        <Link href="https://github.com/llookkeesshh00"><span className='underline font-medium'>https://github.com/llookkeesshh00</span></Link>
                    </div>
                    <div className='flex items-center gap-6'>
