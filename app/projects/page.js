  ...
  return (
    <div className=' w-full min-h-screen p-4 flex gap-4 flex-col shadow-2xs'>
      ...
      <div className="items flex flex-col gap-8 ">
        <div className="item drop-shadow-md rounded-3xl p-6 bg-gray-100 grid grid-cols-2 gap-3 ">
          <div className="image ">
          ...
          <div className="content flex flex-col items-center justify-center gap-3">
            ...
            <div className='flex justify-between gap-14 w-full '>
              <button className="bg-blue-500 rounded-3xl px-4 py-2 font-semibold text-white hover:bg-blue-600 w-1/2 transition">
                Git hub
